...
import { useLinkedInPostsStore } from '@/stores/writerStore';
import { useRouter } from 'next/navigation';
import { Copy, ArrowLeft, Linkedin, Sparkles, Hash } from 'lucide-react';
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-lg font-bold text-gray-800">LinkedIn Post Generator</p>
                                    <p className="text-sm text-gray-500">AI-powered professional content creation</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={handleCopy}
                            disabled={!result}
                            className="flex items-center space-x-2 text-sm px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
                        >
                            <Copy size={16} />
                            <span>Copy</span>
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
                        <div className="flex items-start space-x-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-gray-800">LinkedIn Post Generator</h2>
                                <p className="text-sm text-gray-600">Generate professional and engaging LinkedIn posts using AI.</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Leadership, Technology, Career Growth, Industry Insights"
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full h-11 bg-gradient-to-r from-blue-600 to-blue-700 cursor-pointer hover:from-blue-700 hover:to-blue-800 disabled:bg-blue-400 text-white font-semibold rounded-xl transition-all duration-200 hover:shadow-lg disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                            >
                                {loading ? (
                                    <>
                        ...
                        {result ? (
                            ...
                            <div className="h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-center p-8">
                                ...
                                <p className="text-gray-500 text-[15px]">
                                    Your professional LinkedIn post will appear here after generation.
                                </p>
                            </div>
                        )}
                    </div>
