...
import { Copy, ArrowLeft, FileText, Sparkles, Hash } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">AI-powered blog title creation</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={handleCopy}
                            disabled={!result}
                            className="flex items-center space-x-2 text-sm px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
                        >
                            <Copy size={16} />
                            <span>Copy</span>
                        </button>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
                        <div className="flex items-start space-x-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Generate catchy and SEO-friendly blog titles using AI.</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Digital Marketing, Web Development, Productivity Tips"
                                    className="w-full border-2 border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all duration-200"
                                />
                            </div>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full h-11 bg-orange-600 cursor-pointer hover:bg-orange-700 disabled:bg-orange-400 text-white font-semibold rounded-xl transition-all duration-200 hover:shadow-lg disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                            >
                                {loading ? (
                                    <>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
                        ...
                        {result ? (
                            <div className="max-h-96 overflow-y-auto bg-gradient-to-b from-gray-50 to-white rounded-xl border border-gray-200 p-6">
                                <div className="prose max-w-none prose-orange text-sm whitespace-pre-wrap">
                            ...
                            <div className="h-96 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-center p-8">
                                ...
                                <p className="text-gray-500 text-[15px]">
                                    Your creative blog titles will appear here after generation.
                                </p>
                            </div>
                        )}
                    </div>
